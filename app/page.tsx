    ...
    <main className="campaign-shell">
      ...
      <section id="top" className="hero">
        ...
        <div className="hero-copy">
          ...
          <a href="https://wa.link/50i2yc" target="_blank" rel="noreferrer" className="primary-cta" data-meta-cta="Hero CTA">
      ...
      <section id="reward" className="rewards-stack">
        ...
        {rewardTiers.map((tier, index) => (
          <article className={`tier-card tier-${index + 1}`} key={tier.amount}>
            ...
            />
            <a
              href="https://wa.link/50i2yc"
              target="_blank"
              rel="noreferrer"
              className="tier-action"
              data-meta-cta={`Reward ${index + 1} CTA`}
              aria-label={`奖金 ${index + 1}，立即通过 WhatsApp 参加`}
            >
              <strong>立即参加</strong>
